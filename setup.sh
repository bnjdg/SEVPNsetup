...
clear
echo -e "\033[0;34mFinished Installing SofthEtherVPN."
echo -e "\033[1;34m"
echo -e "Go to the this url to get your OpenVPN config file"
echo -e "\033[1;33m"
cat *_remote*.ovpn | ./scrunge.sh
echo -e "\033[1;34m"
echo -e "Server WAN/Public IP address: ${myip}"
echo -e ""
echo -e "Username and Password pairs for the virtual hub VPN:"
echo -e "\033[1;35mvpn - vpn ; vpn1 - vpn1 ; vpn2 - vpn2 ; vpn3 - vpn3; vpn4 - vpn4"
echo -e "\033[1;34musername and password are the same"
echo ""
echo -e "Ports for SofthEther VPN:"
echo -e "SEVPN/OpenVPN TCP Ports: 80,82,443,995,992,5555,5242,4244,3128,9200,9201,21,137,8484"
echo -e "OpenVPN UDP Ports: 80,82,443,5242,4244,3128,9200,9201,21,137,8484,,5243,9785,2000-4499,4501-8000"
echo -e ""
echo -e "Please use the SE-Server Manager/vpncmd to set a server password for security purposes"
echo -e "\033[1;34myou can run this" && echo -e "\033[0;35mvpncmd 127.0.0.1:5555 /SERVER /CMD:ServerPasswordSet" && echo -e "\033[1;34mto set a password"
